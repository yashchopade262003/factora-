 ...
 * for ProductionOrder. See buyer-service's EntityIdSequenceTest for the
 * rationale.
 */
class EntityIdSequenceTest {

    @Test
    void productionOrderIdStartsAt101() throws NoSuchFieldException {
        Field idField = ProductionOrder.class.getDeclaredField("productionOrderId");
